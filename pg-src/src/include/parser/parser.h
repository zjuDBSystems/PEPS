...
/* Hook for plugins to get control in prev_parser */
typedef List *(*prev_parser_hook_type) (const char *query_string);
extern PGDLLIMPORT prev_parser_hook_type prev_parser_hook;
/*
