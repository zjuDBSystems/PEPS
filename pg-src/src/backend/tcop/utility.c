				   ...
				   QueryCompletion *qc)
{
	...
	PG_TRY();
	{
		...
		switch (nodeTag(parsetree))
		{
			...
			case T_CreateNUDFStmt: /*CREATE INFERENCE_FUNCTION*/
				address = CreateNUDF(pstate, (CreateNUDFStmt *) parsetree);
				break;
...
CreateCommandTag(Node *parsetree)
{
	...
	switch (nodeTag(parsetree))
	{
		...
		case T_CreateNUDFStmt:
			tag = CMDTAG_CREATE_INFERENCE_FUNCTION;
			break;
